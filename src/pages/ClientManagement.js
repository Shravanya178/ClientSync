        ...
        <div className="bg-gradient-to-br from-red-50 to-pink-50 rounded-2xl shadow-lg p-6 border-2 border-red-200">
          <div className="flex justify-between items-center mb-6">
            ...
            <button
              ...
              className="text-gray-400 hover:text-gray-600 p-2 hover:bg-red-100 rounded-xl transition-all"
            >
              <X className="w-5 h-5" />
            </button>
          </div>
          <form onSubmit={handleAddClient} className="space-y-6">
            ...
            <div className="flex justify-end space-x-4 pt-4">
              ...
              <button
                type="submit"
                className="bg-gradient-to-r from-red-600 to-pink-600 text-white px-6 py-3 rounded-xl hover:from-red-700 hover:to-pink-700 flex items-center space-x-2 shadow-lg transition-all font-medium"
              >
        ...
        <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl shadow-lg p-6 border-2 border-blue-200">
          <div className="flex justify-between items-center mb-6">
            <h3 className="text-xl font-semibold text-gray-900 flex items-center">
              ...
              Add Project to {selectedClient}
            </h3>
            <button
              onClick={() => setShowAddProjectForm(false)}
              className="text-gray-400 hover:text-gray-600 p-2 hover:bg-blue-100 rounded-xl transition-all"
            >
              <X className="w-5 h-5" />
            </button>
          </div>
          <form onSubmit={handleAddProject} className="space-y-6">
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border-2 border-blue-200 rounded-xl bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all"
            ...
            <div className="flex justify-end space-x-4 pt-4">
              ...
              <button
                type="submit"
                className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-6 py-3 rounded-xl hover:from-blue-700 hover:to-indigo-700 flex items-center space-x-2 shadow-lg transition-all font-medium"
              >
                <Save className="w-5 h-5" />
