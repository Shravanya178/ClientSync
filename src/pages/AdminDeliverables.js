...
const AdminDeliverables = ({ user, selectedClient, selectedProject }) => {
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div className="bg-gradient-to-r from-red-600 to-pink-600 rounded-2xl shadow-lg p-6 border-2 border-black text-white">
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-red-100 mt-1">Manage project deliverables and resources</p>
          </div>
          <button
            onClick={() => setShowAddForm(true)}
            className="bg-white text-red-600 px-6 py-3 rounded-xl hover:bg-red-50 flex items-center space-x-2 font-medium shadow-lg transition-all"
          >
      ...
      {showAddForm && (
        <div className="bg-gradient-to-br from-red-50 to-pink-50 rounded-2xl shadow-lg p-6 border-2 border-red-200">
          ...
          <form onSubmit={handleAddDeliverable} className="space-y-6">
            ...
            <div>
              ...
              <div className="border-2 border-dashed border-red-300 rounded-xl p-6 bg-gradient-to-br from-red-50 to-pink-50 hover:border-red-400 transition-all">
                <input
                  type="file"
                  multiple
                ...
                >
                  <Upload className="w-10 h-10 text-red-400 mb-3" />
                ...
                <div className="mt-4">
                  ...
                  <div className="space-y-2">
                    {selectedFiles.map((file, index) => (
                      <div key={index} className="flex items-center justify-between p-3 bg-white rounded-xl border border-red-200 shadow-sm">
                        ...
                        <span className="text-xs text-gray-500 bg-gray-100 px-2 py-1 rounded-lg">{formatFileSize(file.size)}</span>
                      </div>
                    ))}
                  </div>
                </div>
