...
import { LogIn, Mail, Lock, User, AlertCircle, ArrowRight } from "lucide-react";
...
const ClientLogin = () => {
  ...
  const createOrUpdateUserDocument = async (user) => {
    try {
      ...
      if (!userDoc.exists()) {
        // Create new user document with client role
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8 fade-in">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-2">ClientSync</h1>
          <p className="text-gray-600">Client Project Management Portal</p>
        </div>
        ...
        <div className="mt-6">
          ...
          <button
            ...
            disabled={loading}
            className="mt-4 w-full bg-white border border-gray-300 text-gray-700 py-3 px-4 rounded-lg hover:bg-gray-50 focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center"
          >
        ...
        <div className="mt-6 p-4 bg-indigo-50 border border-indigo-200 rounded-lg">
          <h3 className="text-sm font-medium text-indigo-900 mb-2">What you can do:</h3>
          <ul className="text-xs text-indigo-700 space-y-1">
            <li>• Track your project progress in real-time</li>
            <li>• Get help with callback, email, or Google Meet</li>
